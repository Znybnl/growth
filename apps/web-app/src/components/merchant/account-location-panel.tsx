        ...
        <DialogShell open={isAdding} onClose={() => setIsAdding(false)} labelledBy="create-location-title" className="max-w-xl p-6 md:p-8">
            ...
            <div role="form" className="mt-7 space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block text-sm"><span className="mb-2 block font-medium text-graphite">Ville</span><Input value={form.city} onChange={(event) => setForm((current) => ({ ...current, city: event.target.value }))} placeholder="Paris République" /></label>
