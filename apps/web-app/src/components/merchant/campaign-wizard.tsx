...
export function CampaignWizard({ merchant }: { merchant: Merchant }) {
  ...
  async function saveCampaign(isActive: boolean) {
    ...
    try {
      ...
      if (!response.ok)
        throw new Error(
          payload?.error || "La campagne nâ€™a pas pu Ãªtre enregistrÃ©e.",
        );
      ...
      setError(
        saveError instanceof Error
          ? saveError.message
          : "La campagne nâ€™a pas pu Ãªtre enregistrÃ©e.",
      );
    } finally {
      setIsSaving(false);
    }
    ...
    return (
      <div className="okado-card mx-auto max-w-3xl p-8 text-center sm:p-12">
        ...
        <h1 className="okado-page-title mt-3">
          Votre animation est enregistrÃ©e.
        </h1>
        <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-[#626d82]">
          Votre campagne est prÃªte. PrÃ©visualisez-la, tÃ©lÃ©chargez son QR code
          ou prÃ©parez son affiche.
        </p>
  ...
  return (
    <div className="okado-wizard space-y-6 pb-10">
      <section className="flex flex-col gap-5 px-1 py-2 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <p className="okado-label">Assistant guidÃ©</p>
          <h1 className="okado-page-title mt-3">CrÃ©er une campagne</h1>
          <p className="mt-4 max-w-3xl text-sm leading-7 text-ash">
            Cinq Ã©tapes courtes et un aperÃ§u mobile pour comprendre exactement
      ...
      <div className="grid gap-6 xl:items-start xl:grid-cols-[240px_minmax(0,1fr)_360px]">
        <aside className="okado-card p-4">
          ...
          <nav className="mt-4 space-y-1" aria-label="Ã‰tapes de crÃ©ation">
        ...
        <main className="okado-card min-w-0 p-5 sm:p-8">
          ...
          {step.id === "identity" ? (
            <div className="mt-7 space-y-5">
              ...
              <label className="block">
                <span className="text-sm font-semibold text-[#182033]">
                  Promesse affichÃ©e au client
                </span>
                <span className="mt-1 block text-xs text-[#8993a6]">
                  Une phrase courte, concrÃ¨te et facile Ã  comprendre sur mobile.
                </span>
                <textarea
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block">
                  ...
                  >
                    ...
                    <option value="social_follow">Gagner des abonnÃ©s</option>
                  </select>
                </label>
                <label className="block">
                  <span className="text-sm font-semibold text-[#182033]">
                  ...
                  [
                    {
                      ...
                      text: "Un moment spectaculaire, idÃ©al sur un comptoir.",
                    },
                    {
                      value: "scratch",
                      label: "Ticket Ã  gratter",
                      text: "Un geste tactile simple et immÃ©diat sur mobile.",
                    },
                  ] as const
                ).map((option) => (
                  <button
                ...
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-[#8993a6]">
                      Les rÃ¨gles ci-dessous sâ€™appliquent immÃ©diatement au
                  ...
                  <label className="flex items-start gap-3 rounded-[16px] border border-[#e2e8f0] bg-white p-4 text-sm text-[#182033]">
                    ...
                    <span>
                      ...
                      <span className="mt-1 block text-xs leading-5 text-[#7a8498]">
                        Chaque participation reÃ§oit un lot. Le total des
                        probabilitÃ©s doit Ãªtre Ã©gal Ã  100 %.
                      </span>
                    </span>
                  </label>
                  <label className="flex items-start gap-3 rounded-[16px] border border-[#e2e8f0] bg-white p-4 text-sm text-[#182033]">
                    ...
                    <span>
                      ...
                      <span className="mt-1 block text-xs leading-5 text-[#7a8498]">
                        La caisse demandera une confirmation dâ€™achat avant de
                        remettre le lot.
                      </span>
                    </span>
                  </label>
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm font-semibold text-[#182033]">
                      {draft.rewardRules.isWinningEveryTime
                        ? "Un lot Ã  chaque participation"
                        : "Gain selon les probabilitÃ©s"}
                    </p>
                  </div>
                  <div
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm font-semibold text-[#182033]">
                      {draft.rewardRules.purchaseRequired
                        ? "Achat vÃ©rifiÃ© en caisse"
                        : "Sans condition dâ€™achat"}
                    </p>
                  </div>
                </div>
              </div>
          ...
          {step.id === "prizes" ? (
            <div className="mt-7 space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-[#8993a6]">
                    La jauge doit rester Ã  100 % maximum.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  <span
              ...
              {totalProbability > 100.0001 ? (
                ...
                >
                  Le total des probabilitÃ©s dÃ©passe 100 %. Vous pouvez encore
                  ajouter ou modifier des lots, mais rÃ©duisez ce total avant de
                  continuer.
                </div>
              ) : null}
                ...
                >
                  ...
                  <label className="mt-3 block">
                    <span className="text-xs text-[#8993a6]">
                      Conditions dâ€™utilisation (optionnel)
                    </span>
                    <input
                  ...
                  >
                    ...
                    <div className="mt-4 grid gap-4 sm:grid-cols-2">
                      <label className="block">
                        ...
                        >
                          ...
                          <option value="crm">
                            Rejoindre le programme fidÃ©litÃ©
                          </option>
                          <option value="custom">
                    ...
                    {action.kind !== "crm" ? (
                      ...
                      <p className="mt-4 rounded-[12px] bg-[#f6f8fb] px-3 py-2 text-xs leading-5 text-[#69758a]">
                        Cette action est gÃ©rÃ©e dans votre espace fidÃ©litÃ© ;
                        aucun lien externe nâ€™est requis.
                      </p>
                    )}
                  </div>
                ))}
          ...
          {step.id === "appearance" ? (
            <div className="mt-7 space-y-5">
              ...
              <div className="rounded-[20px] border border-[#e2e8f0] bg-[#fbfcfe] p-5">
                ...
                <p className="mt-1 text-xs text-[#8993a6]">
                  Nous utiliserons le logo du commerce si vous en avez dÃ©jÃ 
                  configurÃ© un.
                </p>
