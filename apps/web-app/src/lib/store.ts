    ...
    presentation: {
      ...
      poster: normalizePosterSettings(
        ...
        createPosterSettingsDefaults({
          ...
          headlineTextColor: p…9803 tokens truncated…input.id ? getCampaign(input.id) : undefined;
...
export async function recordEvent(
  ...
  if (getDataBackend("l'enregistrement d'un Ã©vÃ©nement campagne") === "supabase") {
