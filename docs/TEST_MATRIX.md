...
| TM-004 | Enregistrement d'un brouillon dans le Wizard | Marchand connecté | Saisir un jeu incomplet puis enregistrer le brouillon | Le brouillon est enregistré et apparaît immédiatement dans Mes jeux | Vérification manuelle propriétaire | À automatiser |
